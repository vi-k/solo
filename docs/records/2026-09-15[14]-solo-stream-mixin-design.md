> **Состояние на 2026-09-16:** спека прошла два независимых ревью, принятое внесено; оба открытых вопроса решены владельцем 2026-09-16. План — `2026-09-16[3]-solo-stream-mixin-plan.md`.
