...
> 3.1, 4.8, 4.9, 6.2, 7.3). Уточнена 2026-09-04: `cancellable` спрашивают
> и изнутри тела, через `ctx.cancellable`, — всё, что здесь сказано про
...
> `2026-09-04[3]-cancellable-design.md` (`cancellable` спрашивают дважды),
