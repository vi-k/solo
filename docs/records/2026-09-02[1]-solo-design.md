...
> владельцем в диалоге, документ прочитан им целиком без замечаний. В тот
> же день по решению владельца стрим стал асинхронным (правки в 3.1, 4.8,
> 4.9, 6.2, 7.3). Реализация не начата, план написан.
