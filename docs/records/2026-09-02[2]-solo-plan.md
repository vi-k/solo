...
> `main` (`03c8255`..коммит задачи 20). Просмотрен владельцем 2026-09-02
> перед исполнением: пол SDK поднят до `^3.6.0`, зависимости согласованы с
> Flutter 3.27, отложенная публикация заменена асинхронным стримом.
