> **Состояние на 2026-09-12:** сделано и смержено. **Пересмотрено
> 2026-09-16:** решение «братья, а не цепочка» (что `SoloListenable`
> и стримовый контроллер — сёстры, а не наследники друг друга)
