...
> **Состояние на 2026-09-25:** выполнен целиком, работа влита в `main`
> (`eb94a2a`); отчёт — `2026-09-22-error-hook-split-report.md`. Открытый
> вопрос 4 («в `async_job` править нечего») пересмотрен 2026-09-25: верно для
> автора движка, а пользователь ядра видит один `JobObserver` на обе работы.
> Разделение в ядре — `2026-09-25-core-error-hook-split-plan.md`.
