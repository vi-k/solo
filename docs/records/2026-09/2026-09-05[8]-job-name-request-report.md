> **Состояние на 2026-09-12:** решение «публиковать как `jobs`» больше не
> исполнимо: pub.dev отклонил загрузку — имя слишком похоже на занятое
> `job`. Письмо держателю отправлено 2026-09-06 владельцем; на 2026-09-12
> ответа по-прежнему нет, проверено владельцем.
