...
Что значит «в зону» во Flutter: ошибка уходит в
`PlatformDispatcher.instance.onError`, если он задан, и в лог движка, если
нет. Приложение от этого **не падает** — `EXIT=255` обычной программы на
