...
await job.cancel();  // возвращается, когда задача действительно остановилась
...
здесь, — в [solo и bloc рядом](../../docs/ru/solo/vs-bloc.md).
...
`close()` отменяет то, что выполняется, — тело остановится на ближайшем
