...
**Ошибки уборщика.** Они уходят в `onError` и в `SoloBase.observer`, и
дальше никуда: в `solo` у задачи наблюдатель есть всегда, поэтому до зоны
ничего не доходит. Если не переопределено ни то ни другое, уборщик,
тронувший контекст, останавливается на первой строке, и об этом не узнает
никто — ставьте наблюдателя на старте, как сказано в разделе
[Ошибки](#ошибки).
