...
/// [JobContext.onCancel], a failure of work handed over with
/// [JobContext.unattended] — take the other path: [JobObserver.onError],
/// or straight to the zone when there is no observer.
